...
// TEST(TestSuite, test_constructor)
// {
//     gtsam::DiscreteFactorGraph dfg = build_test_factor_graph();

//     FactorGraph fg(dfg);

//     std::cout << "Num nodes in fg: " << fg.nodes().size() << "\n";
//     std::cout << "Variables in graph:\n";
//     for (const FactorGraph::Node::shared_ptr& n : fg.nodes()) {
//         std::cout << "*******************\n";
//         n->print();
//         std::cout << "\n::::::::::::\nWith neighbors " << n->num_neighbors() << ":\n";

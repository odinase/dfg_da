% Version 3: I want to see how much I can resolve agglomeration by recycling misdetection tracks
...
tracks = find(lastConsecutiveMisdets > 1 & trackProbs < 0.04);
...
for ii=1:size(meaHistCol,2)
    ...
    if(ismember(ii,tracks))
        ...
        el = getellipse03(trackFile(inCol.tarX(1:2),ii),pMat(1:2,1:2),3,200);

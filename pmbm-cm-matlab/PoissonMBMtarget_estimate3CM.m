function X_estimate=PoissonMBMtarget_estimate3CM(filter_upd,hypos,hyposCard,clusters,clustersCard,inCol,trackFile)

%Author: Angel F. Garcia Fernandez 
% Version to work with CM PMBM filter by Edmund Brekke

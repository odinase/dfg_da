function [hyposNew,hyposNewCard,clustersNew,clustersNewCard,probabilitiesAS,splittingTracks] = clusterSplittingMaj(hypos,hyposCard,clusters,clustersCard,probLogHypos,trackFile,sig,meaHistCol,inCol,splittingThreshold,mahaCSThres,k)
...
for c=1:nC
    ...
    for t=1:nTA
        ...
        for jj=setdiff(1:nTA,t)
            if(~ismember(jj,ia) && ~ismember(t,ia))  % Check whether both t and jj are active tracks
